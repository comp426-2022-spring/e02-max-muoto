...
// 1. Create other variables for assignments, exams, and engagement here
    ...
    let currentAS1 = document.querySelector('#as1').value
    let currentAS2 = document.querySelector('#as2').value
    let currentAS3 = document.querySelector('#as3').value
    if(currentSum==='')
    return;
// 2. This line is where you add the points all together. Add your other variable references here. Make sure that they match what is above and what is below in the HTML form
    ...
    + parseInt(currentA99) + parseInt(currentE01) + parseInt(currentE02)+ (parseInt(currentCommits) * 500) + parseInt(currentAS1) + parseInt(currentAS2)+ parseInt(currentAS3);
    setCurrentSum(sum);
  }
